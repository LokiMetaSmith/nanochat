...
if use_vision:
    # We ignore robotics in dataloader for now (needs update to synthesize/load robotics data)
    # The dataloader only returns vision + text
    x, y, images, dataloader_state_dict = batch_data
else:
    x, y, dataloader_state_dict = batch_data
    images = None

# TODO: Add Robotics Data Loading support to `dataloader.py`
# For now, we will synthesize random robotics data inside the training loop if enabled
# This keeps the changes minimal for testing
